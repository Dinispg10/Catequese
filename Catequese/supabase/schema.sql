...
do $$
begin
    if exists (select 1 from pg_constraint where conname = 'presencas_mensais_unique') then
    alter table presencas_mensais
      drop constraint presencas_mensais_unique;
  end if;

  alter table presencas_mensais
    add constraint presencas_mensais_unique
    unique (aluno_id, ano_matricula, ano_catecismo);
...
begin
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'paroquias' and policyname = 'authenticated_select'
  ) then
    create policy "authenticated_select" on paroquias for select to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'paroquias' and policyname = 'authenticated_insert'
  ) then
    create policy "authenticated_insert" on paroquias for insert to authenticated with check (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'paroquias' and policyname = 'authenticated_update'
  ) then
    create policy "authenticated_update" on paroquias for update to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'paroquias' and policyname = 'authenticated_delete'
  ) then
    create policy "authenticated_delete" on paroquias for delete to authenticated using (true);
  end if;

  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'escolas' and policyname = 'authenticated_select'
  ) then
    create policy "authenticated_select" on escolas for select to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'escolas' and policyname = 'authenticated_insert'
  ) then
    create policy "authenticated_insert" on escolas for insert to authenticated with check (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'escolas' and policyname = 'authenticated_update'
  ) then
    create policy "authenticated_update" on escolas for update to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'escolas' and policyname = 'authenticated_delete'
  ) then
    create policy "authenticated_delete" on escolas for delete to authenticated using (true);
  end if;

  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'catequistas' and policyname = 'authenticated_select'
  ) then
    create policy "authenticated_select" on catequistas for select to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'catequistas' and policyname = 'authenticated_insert'
  ) then
    create policy "authenticated_insert" on catequistas for insert to authenticated with check (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'catequistas' and policyname = 'authenticated_update'
  ) then
    create policy "authenticated_update" on catequistas for update to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'catequistas' and policyname = 'authenticated_delete'
  ) then
    create policy "authenticated_delete" on catequistas for delete to authenticated using (true);
  end if;

  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'centros_catequese' and policyname = 'authenticated_select'
  ) then
    create policy "authenticated_select" on centros_catequese for select to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'centros_catequese' and policyname = 'authenticated_insert'
  ) then
    create policy "authenticated_insert" on centros_catequese for insert to authenticated with check (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'centros_catequese' and policyname = 'authenticated_update'
  ) then
    create policy "authenticated_update" on centros_catequese for update to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'centros_catequese' and policyname = 'authenticated_delete'
  ) then
    create policy "authenticated_delete" on centros_catequese for delete to authenticated using (true);
  end if;

  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'alunos' and policyname = 'authenticated_select'
  ) then
    create policy "authenticated_select" on alunos for select to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'alunos' and policyname = 'authenticated_insert'
  ) then
    create policy "authenticated_insert" on alunos for insert to authenticated with check (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'alunos' and policyname = 'authenticated_update'
  ) then
    create policy "authenticated_update" on alunos for update to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'alunos' and policyname = 'authenticated_delete'
  ) then
    create policy "authenticated_delete" on alunos for delete to authenticated using (true);
  end if;

  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'presencas_mensais' and policyname = 'authenticated_select'
  ) then
    create policy "authenticated_select" on presencas_mensais for select to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'presencas_mensais' and policyname = 'authenticated_insert'
  ) then
    create policy "authenticated_insert" on presencas_mensais for insert to authenticated with check (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'presencas_mensais' and policyname = 'authenticated_update'
  ) then
    create policy "authenticated_update" on presencas_mensais for update to authenticated using (true);
  end if;
  if not exists (
    select 1 from pg_policies where schemaname = 'public' and tablename = 'presencas_mensais' and policyname = 'authenticated_delete'
  ) then
